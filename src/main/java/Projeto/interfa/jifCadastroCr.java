 ...
 */
public class jifCadastroCr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        id_pedido_cr = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        data_cr = new javax.swing.JTextField();
        ...
        id_pedido_cr.setEnabled(false);

        jLabel2.setForeground(new java.awt.Color(13, 36, 125));
        jLabel2.setText("Data do Faturamento:");

        data_cr.setEnabled(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(data_cr, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(id_pedido_cr, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cancelar))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(data_cr, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(novo)
                    .addComponent(editar)
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        ...
        if (acao == 1) {
            ...
            try {
                ...
                String data = data_cr.getText().trim();
                String idPed = id_pedido_cr.getText().trim();

                // verifica se os campos estão nulos
                if (data != null && !data.isEmpty() && idPed != null && !idPed.isEmpty()) {
                    //passando por parametros para a função que insere os clientes no BD
                    int idPedido = Integer.parseInt(idPed);
                    ins.insereContasReceber(conexao, idPedido, data);
            ...
            try {
                ...
                if (cod_cr != null && !cod_cr.isEmpty()) {

                    int cod1 = Integer.parseInt(cod_cr);
                    String data = data_cr.getText().trim();
                    String idPed = id_pedido_cr.getText().trim();
                    int idPedido = Integer.parseInt(idPed);

                    edit.editaCr(conexao, data, idPedido, cod1);
            ...
            try {
                ...
                if (cod_cr != null && !cod_cr.isEmpty()) {
                    ...
                    int codCr = Integer.parseInt(cod_cr);
                    del.deletaCr(conexao, codCr);
    ...
    private javax.swing.JTextField data_cr;
    private javax.swing.JButton editar;
    private javax.swing.JButton excluir;
    private javax.swing.JTextField id_pedido_cr;
    ...
    public void novo() {
        jcod.setEnabled(false);
        data_cr.setEnabled(true);
        id_pedido_cr.setEnabled(true);
        salvar.setEnabled(true);
        excluir.setEnabled(true);
        cancelar.setEnabled(true);
        salvar_edit.setEnabled(false);
        data_cr.setText("");
        id_pedido_cr.setText("");
    }
